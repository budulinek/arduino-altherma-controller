...
| - WiFi                             | - Ethernet                                        | Arnold-n/P1P2Serial                                      | raomin/ESPAltherma                                                            | tadasdanielius/daikin_altherma                        | speleolontra/daikin_residential_altherma     |   |
|------------------------------------|---------------------------------------------------|----------------------------------------------------------|-------------------------------------------------------------------------------|-------------------------------------------------------|----------------------------------------------|---|
| Cloud                              |                                                   | - Custom all-in-one board                                | - M5StickC (or any ESP32/ESO8266   board)<br>     - external relay (optional) | - Daikin Altherma LAN adapter (BRP069A62 / BRP069A61) | - Daikin LAN adapter (BRP069C4x / BRP069B4x) |   |
| **Programable MCUs**               | 1 (ATmega 328P)                                   | 2 (ATmega 328P + ESP8266 )                               | 1 (ESP32/ESP8266)                                                             | ---                                                   | ---                                          |   |
| **Connection to Daikin Altherma**  | P1/P2 bus                                         | P1/P2 bus                                                |                                                                               | P1/P2 bus                                             | P1/P2 bus                                    |   |
| **Interface**                      | - Ethernet                                        | - WiFi<br>     - Ethernet (optional)                     | - WiFi                                                                        | - Ethernet                                            | - WiFi (Cloud)                               |   |
...
| **OTA updates**                    | No                                                | Yes                                                      | Yes                                                                           | Yes                                                   | Yes                                          |   |
| **Read data from Daikin Altherma** | Yes                                               | Yes                                                      | Yes                                                                           | Limited                                               | Limited                                      |   |
| **Control Daikin Altherma**        | Yes                                               | Yes                                                      | Limited (with optional external relay)                                        | Yes                                                   | Yes                                          |   |
